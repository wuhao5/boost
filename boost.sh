...
restoreBoost()
{
	cp $SRCDIR/tools/build/v2/user-config.jam-bk $SRCDIR/tools/build/v2/user-config.jam 
}
...
updateBoost()
{
	...
	cp $SRCDIR/tools/build/v2/user-config.jam $SRCDIR/tools/build/v2/user-config.jam-bk
	cat >> $SRCDIR/tools/build/v2/user-config.jam <<EOF
